...
const RelativesViewContent = () => {
  ...
  const t = {
    de: {
      ...
      mainMessage: 'Alles Wichtige auf einen Blick.',
      mainMessageSub: 'Hier findest Du eine Übersicht der hinterlegten Informationen. Nimm Dir die Zeit, die Du brauchst.',
    ...
    en: {
      ...
      mainMessage: 'Everything important at a glance.',
      mainMessageSub: 'Here you will find an overview of the recorded information. Take the time you need.',
