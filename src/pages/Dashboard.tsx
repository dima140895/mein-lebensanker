...
const DashboardContent = () => {
  ...
  const t = {
    de: {
      ...
      personalDesc: 'Name, Geburtsdatum, Anschrift, Allergien, Vorerkrankungen, Notfallkontakt',
      assets: 'Vermögen',
      assetsDesc: 'Konten, Immobilien, Versicherungen',
      digital: 'Digital',
    ...
    en: {
      ...
      personal: 'Personal',
      personalDesc: 'Name, date of birth, address, allergies, pre-existing conditions, emergency contact',
      assets: 'Assets',
      assetsDesc: 'Accounts, properties, insurance',
      digital: 'Digital',
