...
const Header = () => {
  ...
  return (
    <>
      ...
      <header className={`sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-border/50 animate-fade-in ${emailVerified ? 'mt-10' : ''}`} style={{ boxShadow: '0 1px 12px -4px hsl(42 30% 85% / 0.5)' }}>
      <div className="container mx-auto flex items-center justify-between px-3 py-2 md:px-4 md:py-4">
        ...
        <nav className="hidden md:flex items-center gap-2">
          ...
          {/* Authenticated users: navigation is handled by sidebar, no duplicates here */}
