  ...
  return (
    <>
      ...
      <header className={`sticky top-0 z-50 bg-background/95 backdrop-blur-md animate-fade-in ${emailVerified ? 'mt-10' : ''}`}>
        {/* Soft gradient fade below header to eliminate hard edge */}
        <div className="absolute left-0 right-0 top-full h-8 pointer-events-none" style={{ background: 'linear-gradient(to bottom, hsl(40 30% 97% / 0.9), transparent)' }} />
