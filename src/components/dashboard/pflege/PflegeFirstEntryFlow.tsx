...
const PflegeFirstEntryFlow = ({ onSave, isSaving, activePersonName = '' }: PflegeFirstEntryFlowProps) => {
  ...
  const t = {
    de: {
      ...
      meals: 'Mahlzeiten',
      mealsPlaceholder: `Was hat ${pName || 'die Person'} heute gegessen?`,
      incidents: 'Besonderheiten',
      incidentsPlaceholder: `Was war heute bei ${pName || 'der Person'} besonders?`,
      moreFields: 'Weitere Felder',
      lessFields: 'Weniger Felder',
      activities: 'Aktivitäten',
      activitiesPlaceholder: `Was hat ${pName || 'die Person'} heute unternommen?`,
      nextSteps: 'Nächste Schritte',
      nextStepsPlaceholder: `Was ist als nächstes zu tun für ${pName || 'die Person'}?`,
    ...
    en: {
      ...
      meals: 'Meals',
      mealsPlaceholder: `What did ${pName || 'the person'} eat today?`,
      incidents: 'Notable events',
      incidentsPlaceholder: `What was notable about ${pName || 'the person'} today?`,
      moreFields: 'More fields',
      lessFields: 'Less fields',
      activities: 'Activities',
      activitiesPlaceholder: `What did ${pName || 'the person'} do today?`,
      nextSteps: 'Next steps',
      nextStepsPlaceholder: `What needs to be done next for ${pName || 'the person'}?`,
      save: 'Save entry',
      saving: 'Saving...',
    },
  };
