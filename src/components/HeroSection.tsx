  ...
  return (
    <section className="relative min-h-[85vh] flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-6 right-8 text-right pointer-events-none hidden lg:block z-10">
          <p className="font-serif text-sm text-sage-dark/70 tracking-wide italic">
            {language === 'de' 
