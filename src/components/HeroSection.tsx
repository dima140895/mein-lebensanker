...
const HeroSection = () => {
  ...
  return (
    <section className="relative isolate min-h-[55vh] sm:min-h-[70vh] md:min-h-[85vh] flex items-center overflow-hidden">
      ...
      <div className="absolute right-[-5%] md:right-[-8%] lg:right-[-5%] bottom-0 md:bottom-[-10%] lg:bottom-[-12%] w-[80%] sm:w-[75%] md:w-[65%] lg:w-[60%] h-[145%] flex items-end justify-center pointer-events-none">
        <div
          aria-hidden="true"
