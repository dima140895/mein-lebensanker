...
const HeroSection = () => {
  ...
  return (
    <section className="relative isolate min-h-[55vh] sm:min-h-[70vh] md:min-h-[85vh] flex items-center overflow-x-clip">
      ...
      <div className="absolute right-[-10%] md:right-[-12%] lg:right-[-8%] bottom-[-45%] sm:bottom-[-45%] md:bottom-[-45%] lg:bottom-[-55%] w-[70%] sm:w-[65%] md:w-[65%] lg:w-[75%] h-[130%] sm:h-[120%] md:h-[130%] lg:h-[160%] flex items-end justify-center pointer-events-none">
        <div
          aria-hidden="true"
